...
class PetTableViewController: UITableViewController, UIPopoverPresentationControllerDelegate {
  ...
  func search() {
    let searchViewController = storyboard?.instantiateViewController(withIdentifier: "SearchTableViewController") as? UIViewController
  ...
  func settings() {
    let settingsViewController = storyboard?.instantiateViewController(withIdentifier: "SettingsTableViewController") as? UIViewController
